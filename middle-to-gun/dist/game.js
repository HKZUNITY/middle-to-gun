 ...
 * WARNING: DO NOT MODIFY THIS FILE,MAY CAUSE CODE LOST.
 * AUTHOR: 爱玩游戏的小胖子
 * UI: UI/module/HUDModule/Loading.ui
 * TIME: 2024.07.27-20.14.48
 */
let Loading_Generate = class Loading_Generate extends UIScript {
    ...
    initButtons() {
        ...
        //文本多语言
        //文本多语言
        this.initLanguage(this.uiWidgetBase.findChildByPath("RootCanvas/Image/TextBlock"));
    }
    /**初始化多语言*/
    initLanguage(ui) {
        let call = mw.UIScript.getBehavior("lan");
...
Loading_Generate = __decorate([
    UIBind('UI/module/HUDModule/Loading.ui')
], Loading_Generate);
...
class HUDModuleC extends ModuleC {
    ...
    get getLoading() {
        if (!this.loading) {
            this.loading = mw.UIService.getUI(Loading_Generate$1);
        }
        return this.loading;
    }
    onStart() {
...
(function (TaskItemType) {
    ...
    TaskItemType[TaskItemType["DailyKilMonster_1"] = 51] = "DailyKilMonster_1";
    TaskItemType[TaskItemType["DailyKilMonster_5"] = 52] = "DailyKilMonster_5";
    TaskItemType[TaskItemType["DailyKilMonster_10"] = 53] = "DailyKilMonster_10";
    TaskItemType[TaskItemType["DailyKilMonster_20"] = 54] = "DailyKilMonster_20";
    TaskItemType[TaskItemType["DailyKilMonster_30"] = 55] = "DailyKilMonster_30";
    TaskItemType[TaskItemType["DailyKilMonster_50"] = 56] = "DailyKilMonster_50";
    TaskItemType[TaskItemType["DailyKilMonster_100"] = 57] = "DailyKilMonster_100";
    TaskItemType[TaskItemType["DailyKilMonster_200"] = 58] = "DailyKilMonster_200";
    TaskItemType[TaskItemType["DailyKilMonster_300"] = 59] = "DailyKilMonster_300";
    /**每周登录1天 */
...
class PlayerModuleS extends ModuleS {
    ...
    updatePlayerKillCount(killPlayer, diePlayer) {
        ...
        if (killPlayer && diePlayer)
            this.getTaskModuleS.killPlayer(killPlayer);
        if (killPlayer && !diePlayer)
            this.getTaskModuleS.killMonster(killPlayer);
        let names = [];
        if (userId2 != "-1") {
...
const MWModuleMap = { 
     ...
     '6C209C17410545628474A881C3F3B0F2': foreign9,
     ...
     '3973F4D54DF4B91EB33059A1989EEBCF': foreign97,
     'C8DA5246492A8B768EFD11BB64D1C2FD': foreign98,
     '4BAAB5D2447B37D97384719CE67C9E72': foreign99,
...
[foreign9 || {}, "JavaScripts/config/MonsterInfo"],
...
[foreign97 || {}, "JavaScripts/ui-generate/module/HUDModule/Loading_generate"],
[foreign98 || {}, "JavaScripts/ui-generate/module/NpcModule/EnemyLifebar_generate"],
[foreign99 || {}, "JavaScripts/ui-generate/module/RadarModule/RadarPanel_generate"],
