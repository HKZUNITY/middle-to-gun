...
Utils.redTeamRevivalPoint = [ new mw.Vector(-3700, 1500, 200), new mw.Vector(-3700, 1700, 200), new mw.Vector(-3700, 1900, 200), new mw.Vector(-3700, 2100, 200), new mw.Vector(-3700, 2300, 200), new mw.Vector(-3700, 2500, 200), new mw.Vector(-3700, 2700, 200), new mw.Vector(-3700, 2900, 200) ];

Utils.blueTeamRevivalPoint = [ new mw.Vector(2100, 4e3, 200), new mw.Vector(2100, 3800, 200), new mw.Vector(2100, 3600, 200), new mw.Vector(2100, 3400, 200), new mw.Vector(2100, 3200, 200), new mw.Vector(2100, 3e3, 200), new mw.Vector(2100, 2800, 200), new mw.Vector(2100, 2600, 200) ];
...
const EXCELDATA$5 = [ [ "ID", "Name", "TaskType", "TaskItemType", "NextId", "TragetNum", "Coin", "Diamond" ], [ "", "", "", "", "", "", "", "" ], [ 1, "每日登录游戏（{0}/{1}）", 1, 1, 0, 1, 100, 1 ], [ 11, "每日在线时长5分钟（{0}/{1}）", 1, 11, 0, 5, 500, 1 ], [ 12, "每日在线时长10分钟（{0}/{1}）", 1, 12, 0, 10, 500, 5 ], [ 13, "每日在线时长15分钟（{0}/{1}）", 1, 13, 0, 15, 500, 5 ], [ 14, "每日在线时长20分钟（{0}/{1}）", 1, 14, 0, 20, 500, 10 ], [ 15, "每日在线时长25分钟（{0}/{1}）", 1, 15, 0, 25, 500, 10 ], [ 16, "每日在线时长30分钟（{0}/{1}）", 1, 16, 0, 30, 500, 20 ], [ 17, "每日在线时长40分钟（{0}/{1}）", 1, 17, 0, 40, 1e3, 20 ], [ 18, "每日在线时长50分钟（{0}/{1}）", 1, 18, 0, 50, 1e3, 30 ], [ 19, "每日在线时长60分钟（{0}/{1}）", 1, 19, 0, 60, 1e3, 100 ], [ 31, "每日击败1个玩家（{0}/{1}）", 1, 31, 0, 1, 20, 1 ], [ 32, "每日击败5个玩家（{0}/{1}）", 1, 32, 0, 5, 80, 1 ], [ 33, "每日击败10个玩家（{0}/{1}）", 1, 33, 0, 10, 100, 2 ], [ 34, "每日击败20个玩家（{0}/{1}）", 1, 34, 0, 20, 200, 2 ], [ 35, "每日击败30个玩家（{0}/{1}）", 1, 35, 0, 30, 200, 5 ], [ 36, "每日击败50个玩家（{0}/{1}）", 1, 36, 0, 50, 400, 5 ], [ 37, "每日击败100个玩家（{0}/{1}）", 1, 37, 0, 100, 1e3, 10 ], [ 38, "每日击败200个玩家（{0}/{1}）", 1, 38, 0, 200, 2e3, 10 ], [ 39, "每日击败300个玩家（{0}/{1}）", 1, 39, 0, 300, 2e3, 100 ], [ 101, "每周登录1天（{0}/{1}）", 2, 101, 0, 1, 1e3, 1 ], [ 102, "每周登录2天（{0}/{1}）", 2, 102, 0, 2, 1e3, 100 ], [ 103, "每周登录3天（{0}/{1}）", 2, 103, 0, 3, 1e3, 200 ], [ 104, "每周登录4天（{0}/{1}）", 2, 104, 0, 4, 1e3, 300 ], [ 105, "每周登录5天（{0}/{1}）", 2, 105, 0, 5, 1e3, 400 ], [ 106, "每周登录6天（{0}/{1}）", 2, 106, 0, 6, 1e3, 500 ], [ 107, "每周登录7天（{0}/{1}）", 2, 107, 0, 7, 1e3, 600 ] ];
...
HUDPanel1_Generate = __decorate([ UIBind("UI/module/HUDPanel1.ui") ], HUDPanel1_Generate);
