...
import { IColorValueElement } from "../../config/ColorValue";
...
export default class MallModuleC extends ModuleC<MallModuleS, MallData> {
    ...
    private async initNpc(): Promise<void> {
        this.maleNpc = await mw.GameObject.asyncFindGameObjectById(`2CEC2028`) as mw.Character;
        this.feMaleNpc = await mw.GameObject.asyncFindGameObjectById(`1747A541`) as mw.Character;
        this.transitionNpc = await mw.GameObject.asyncFindGameObjectById(`24D5B860`) as mw.Character;
        this.copyNpc = await mw.GameObject.asyncFindGameObjectById(`1C09F670`) as mw.Character;
        await this.localPlayer.character.asyncReady();
        let somatotype = this.localPlayer.character.description.advance.base.characterSetting.somatotype;
