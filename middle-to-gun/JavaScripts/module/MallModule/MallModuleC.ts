...
export default class MallModuleC extends ModuleC<MallModuleS, MallData> {
    ...
    private async initNpc(): Promise<void> {
        this.maleNpc = await mw.GameObject.asyncFindGameObjectById(`358ED182`) as mw.Character;
        this.feMaleNpc = await mw.GameObject.asyncFindGameObjectById(`348DCFA8`) as mw.Character;
        this.transitionNpc = await mw.GameObject.asyncFindGameObjectById(`1572E7B0`) as mw.Character;
        this.copyNpc = await mw.GameObject.asyncFindGameObjectById(`0A1E3A80`) as mw.Character;
        await this.localPlayer.character.asyncReady();
        let somatotype = this.localPlayer.character.description.advance.base.characterSetting.somatotype;
